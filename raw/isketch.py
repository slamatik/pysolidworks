...
NOTE: This property is a get-only property. Set is not implemented."""
	...
	def constrain_all(self):
		"""Attempts to solve all of the apparent relations in the sketch and returns the numberof constraints that were added to the sketch."""
	...
	def get_reference_entity(self, l_entity_type):
		...
		:param l_entity_type: Entity type as defined in swSelectType_e (only swSelFACES and swSelDATUMPLANES are valid values for this method)
		"""
	...
	def insert_route_line(self, items_to_connect, reverse, alternate_path, along_x_y_z):
		...
		:param reverse: Array of Booleans indicating whether to reverse the route line at the corresponding item to connect; true to reverse the direction of the route line, false to not
		:param alternate_path: Array of Booleans indicating whether to display an alternate path at the corresponding item to connect; true to display another possible path for the route line, false to not
		:param along_x_y_z: Array of Booleans indicating whether to create a path parallel to the X, Y, and Z directions from the corresponding item to connect; true to use the X, Y, and Z directions, false to use the shortest route
		"""
	...
	def set_working_plane_orientation(self, origin_x, origin_y, origin_z, x_axis_x, x_axis_y, x_axis_z, y_axis_x, y_axis_y, y_axis_z, normal_x, normal_y, normal_z):
		"""
		...
		"""
		# return self._instance.SetWorkingPlaneOrientation(origin_x, origin_y, origin_z, x_axis_x, x_axis_y, x_axis_z, y_axis_x, y_axis_y, y_axis_z, normal_x, normal_y, normal_z)
		raise NotImplemented
