...
class ITextFormat:
	...
	def char_spacing_factor(self, value):
		"""Gets or sets the factor that controls the spacing between characters."""
	...
	def line_length(self):
		...
		return self._instance.LineLength

	@line_length.setter
	def line_length(self, value):
		"""Gets or sets the text line length in meters."""
		self._instance.LineLength = value
	...
	def width_factor(self):
		...
		return self._instance.WidthFactor
	...
	@is_height_specified_in_pts.setter
	def is_height_specified_in_pts(self, value):
		"""Gets whether the character height is in points or system units."""
		self._instance.IsHeightSpecifiedInPts = value
