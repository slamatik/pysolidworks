...
class IEnumDocuments2:
    ...
    def next(self, celt, rgelt, pcelt_fetched):
        ...
        :param pcelt_fetched: Pointer to the number of documents returned from the list; this value can be less than
        Celt if you ask for more documents than exist, or it can be NULL if no more documents exist.
        """
